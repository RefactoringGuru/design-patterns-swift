...
///
/// Назначение: Динамически подключает к объекту дополнительную
/// функциональность. Декораторы предоставляют гибкую альтернативу практике
/// создания подклассов для расширения функциональности.
